...
class Player():
	...
	def update(self, game_over, world, blob_group, lava_group, exit_group, coin_group, platform_group, screen_width, screen_height, game_over_fx, font, draw_text, screen):
		dx = 0
		dy = 0
		walk_cooldown = 5
		col_thresh = 20
