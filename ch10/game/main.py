...
coin_fx = pygame.mixer.Sound('ch10\game\sounds\img_coin.wav')
coin_fx.set_volume(0.5)
jump_fx = pygame.mixer.Sound('ch10\game\sounds\img_jump.wav')
jump_fx.set_volume(0.5)
game_over_fx = pygame.mixer.Sound('ch10\game\sounds\img_game_over.wav')
...
class Platform(pygame.sprite.Sprite):
	def __init__(self, x, y, move_x, move_y):
		pygame.sprite.Sprite.__init__(self)
		img = pygame.image.load('ch10\game\img\platform.png')
...
class Exit(pygame.sprite.Sprite):
	def __init__(self, x, y):
		pygame.sprite.Sprite.__init__(self)
		img = pygame.image.load('ch10\game\img\exit.png')
