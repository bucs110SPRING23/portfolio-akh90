...
blob_img = pygame.image.load('ch10\game\img\pblob.png')
platform_x_img = pygame.image.load('ch10\game\img\platform_x.png')
platform_y_img = pygame.image.load('ch10\game\img\platform_y.png')
lava_img = pygame.image.load('ch10\game\img\lava.png')
coin_img = pygame.image.load('ch10\game\img\coin.png')
exit_img = pygame.image.load('ch10\game\img\exit.png')
save_img = pygame.image.load('ch10\game\img\save_btn.png')
load_img = pygame.image.load('ch10\game\img\load_btn.png')
...
while run:
	...
	if save_button.draw():
		#save level data
		pickle_out = open(f'ch10\game\levels\level{level}_data', 'wb')
